...
class Search extends Component {
    ...
    constructor(props){
        ...
        this.state={
            ...
            language: ['Turkish', 'English', 'German', 'Italian', 'French', 'Arabic', 'Persian', 'Greek', 'Spanish','Polish', 'Other', 'Unknown']
        }
...
render(){
    ...
    var isbnRegex=new RegExp(this.state.isbn, 'i');
    var editorRegex=new RegExp(this.state.editor, 'i');
    const list = this.props.books.map((book) => {
        let category_matched=this.state.cat.some((category)=>(category===book.cat));
        let language_matched=this.state.language.some((language)=>(language===book.language));
        if(((book.name).search(nameRegex)!==-1)&&((book.author).search(authorRegex)!==-1)&&category_matched && language_matched 
          && ((book.isbn).search(isbnRegex)!==-1) && (book.editor).search(editorRegex) !==-1) 
        return (
    ...
    return(
        ...
        <Row form>
          ...
          <Col md={6}>
            <FormGroup>
              ...
              <Input type="isbn" name="isbn" id="isbn" value={this.state.isbn}  onChange={(e)=>{this.setState({isbn: e.target.value});}} placeholder="Enter isbn" />
            </FormGroup>
          </Col>
          <Col md={6}>
            <FormGroup>
              <Label for="editor">Editpr</Label>
              <Input type="editor" name="editor" id="editor" value={this.state.editor}  onChange={(e)=>{this.setState({editor: e.target.value});}} placeholder="Enter editor" />
            </FormGroup>
          </Col>
        </Row> 
        <Row>
        ...
        <Row>
        <Col xs={6} md={3}>
          <Label check for="Turkish">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Turkish" value="Turkish" name="language" />
            Turkish 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="English">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="English" value="English" name="language" />
            English 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="German">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="German" value="German" name="language" />
            German 
          </Label>
        </Col>
        ...
        <Col xs={6} md={3}>
          <Label check for="Italian">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Italian" value="Italian" name="language" />
            Italian 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="French">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="French" value="French" name="language" />
            French 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="Arabic">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Arabic" value="Arabic" name="language" />
            Arabic 
          </Label>
        </Col>
        ...
        <Col xs={6} md={3}>
          <Label check for="Persian">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Persian" value="Persian" name="language" />
            Persian 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="Greek">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Greek" value="Greek" name="language" />
            Greek 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="Spanish">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Spanish" value="Spanish" name="language" />
            Spanish 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="Polish">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Polish" value="Polish" name="language" />
            Polish 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="Other">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Other" value="Other" name="language" />
            Other 
          </Label>
        </Col>
        <Col xs={6} md={3}>
          <Label check for="Unknown">
            <Input defaultChecked type="checkbox" onChange={this.onChange} id="Unknown" value="Unknown" name="language" />
            Unknown 
          </Label>
        </Col>
        </Row>
