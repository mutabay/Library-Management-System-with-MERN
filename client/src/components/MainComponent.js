...
const mapDispatchToProps = dispatch => ({
  ...
  postBook: (name, author, description, isbn, cat, shelf, floor,  copies, publishYear, editor, publisher, edition, pageCount, language) => dispatch(postBook(name, author, description, isbn, cat, shelf, floor,  copies, publishYear, editor, publisher, edition, pageCount, language)),
  editBook: (_id, name, author, description, isbn, cat, shelf, floor,  copies, publishYear, editor, publisher, edition, pageCount, language) => dispatch(editBook(_id, name, author, description, isbn, cat, shelf, floor,  copies, publishYear, editor, publisher, edition, pageCount, language)),
  ...
  componentDidMount() {
    ...
    constructor(props){
      ...
      handleSubmitEdit(values) {
        ...
        this.props.editBook(this.state.selectedBook._id, values.name, values.author, values.description, values.isbn, 
          values.cat, values.shelf, values.floor, values.copies, values.publishYear, values.editor, values.publisher, 
          values.edition, values.pageCount, values.language );     
        }
          ...
          {this.state.selectedBook?(
                 <Modal isOpen={this.state.isEditModalOpen} toggle={this.toggleEditModal}>
                    ...
                    <Row className="form-group">
                            ...
                            <Row className="form-group">
                                <Label htmlFor="editor" md={2}>Editor </Label>
                                <Col md={10}>
                                    <Control.text model=".editor" id="editor" name="editor"
                                        defaultValue={this.state.selectedBook.editor}
                                        className="form-control"
                                        validators={{
                                            required, minLength: minLength(3)
                                        }}
                            ...
                            <Row className="form-group">
                                <Label htmlFor="edition" md={4}>Edition</Label>
                                <Col md={8}>
                                    <Control.text model=".edition" id="edition" name="edition"
                                        defaultValue={this.state.selectedBook.edition}
                                        className="form-control"
                                        validators={{
                            ...
                            <Row className="form-group">
                                <Label htmlFor="pageCount" md={4}>Page Count</Label>
                                <Col md={8}>
                                    <Control.text model=".pageCount" id="pageCount" name="pageCount"
                                        defaultValue={this.state.selectedBook.pageCount}
                                        className="form-control"
                                        validators={{
                        ...
                        <Row className="form-group">
                            ...
                            <Control.select model=".language" id="language" className="form-control" defaultValue={this.state.selectedBook.language}>
                              {languageItems}
                            </Control.select>
                            </Col>
                        </Row>
                        ...
                        <Row className="form-group">
                                <Label htmlFor="publishYear" md={6}> Publish Year</Label>
                                <Col md={6}>
                                    <Control.text model=".publishYear" id="publishYear" name="publishYear"
                                        defaultValue={this.state.selectedBook.publishYear}
                                        className="form-control"
                                        validators={{
