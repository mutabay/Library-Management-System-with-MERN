       ...
       {isAdmin?(<span className="fa fa-pencil Option" onClick={()=>{changeSelected(book._id);toggleEditModal();}}/>):(<React.Fragment/>)}
        ...
        <CardBody>
          ...
          <CardText>
              ...
              <b> Publish Year: </b><br/> {book.publishYear} <br/><br/>
              <b> Editor: </b><br/> {book.editor} <br/><br/>
              <b> Publisher: </b><br/> {book.publisher} <br/><br/>
              <b> Edition: </b><br/> {book.edition} <br/><br/>
              <b> Page Count: </b><br/> {book.pageCount} <br/><br/>
