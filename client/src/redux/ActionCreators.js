...
export const postBook = (name, author, description, isbn, cat, shelf, floor,  copies, publishYear, editor, publisher, edition, pageCount, language) => (dispatch) => {
    const newBook = {
      name: name, author: author,
        description: description, isbn: isbn,
        cat: cat, shelf: shelf, floor: floor, copies: copies, publishYear:publishYear, 
...
export const editBook = (_id, name, author, description, isbn, cat, shelf, floor,  copies, publishYear, editor, publisher, edition, pageCount, language) => (dispatch) => {
